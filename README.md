...
## Deliverable Focus
Project Deliverable 1 is limited to data collection, data cleaning, and exploratory data analysis using the Online Retail data set.
...
- The cleaned dataset provides a strong foundation for later modeling.
...
## Files Included
- `MSCS_634_Project_Deliverable_1.ipynb`
- `README.md`
- `Sandeep_Parupalli_Project_Deliverable_1_APA7_With_Repo_Link.docx`

## Source
UCI Machine Learning Repository. (n.d.). *Online retail data set*. https://archive.ics.uci.edu/dataset/352/online%2Bretail
